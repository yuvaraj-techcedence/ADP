...
//                  + "databaseName=Zaeplex_java;user=GaneshKumar;password=Ganesh12#;";  
            String connectionUrl =  "jdbc:sqlserver://SQLDEV\\ZAEPLEXINSTANCE;"
                 + "databaseName=Zaeplex;user=ADP;password=ZaeplexAD#Prod;";  
...
"productName ,productGroup ,sassRefString ,createeddate)"+ " values('"+aAList.get(0).get("value")+"','"+aAList.get(1).get("value")+"',"+
    ...
    String query="select  StreetAddress,City,State,Zip,EyeColor,HairColor,"
            + "Height,Race,Weight from CriminalCaseAdditionalIdentifiers where CriminalCaseID="+_criminalCaseID+"";
    try
    {
    stmt=conn.createStatement();
...
public String  getDisPosiTionDetails(String _detailsID)
{
    ...
    String query="select DispostionDetail from DispositionDetails where DetailID="+_detailsID+"";
    try
    {
    stmt=conn.createStatement();
    rs=stmt.executeQuery(query);
...
"		  FinalDispositionDate,FinalChargeLevel,FinalChargeDegree,OriginalChargeLevel,OriginalChargeDegree,\n" +
"FinalDispositionDetails,CostFineRestitutionAmount,FinalChargeDescription ,FinalDisposition from criminalCharges where CriminalCaseID="+_crimnalId+"";
    try
    {
    stmt=conn.createStatement();
    rs=stmt.executeQuery(query);
    ...
    {
        HashMap<String,String>map=new HashMap<String,String>();
        map.put("AmountSuspended",""+rs.getString(1) );
        map.put("Cost",""+rs.getString(2) );
        map.put("Fine",""+rs.getString(3) );
        map.put("Restitution",""+rs.getString(4) );
        map.put("ConfinementCreditedDays",""+rs.getString(5) );
        map.put("ConfinementCreditedMonths",""+rs.getString(6) );
        map.put("ConfinementCreditedYears",""+rs.getString(7) );
        map.put("ConfinementStayedDays",""+rs.getString(8) );
        map.put("ConfinementStayedMonths",""+rs.getString(9) );
        map.put("ConfinementStayedYears",""+rs.getString(10) ); 
        map.put("ConfinementSuspendedDays",""+rs.getString(11) );
        map.put("ConfinementCreditedMonths",""+rs.getString(12) );
        map.put("ConfinementCreditedYears",""+rs.getString(13) );        
        map.put("ConfinementFacilityDays",""+rs.getString(14) );
        map.put("ConfinementFacilityMonths",""+rs.getString(15) );
        map.put("ConfinementSuspendedMonths",""+rs.getString(16) );
        map.put("ConfinementSuspendedYears",""+rs.getString(17) );
        map.put("ConfinementFacilityYears",""+rs.getString(18) ); 
        
        map.put("WarrantStartReason",""+rs.getString(19) );
        map.put("WarrantStartDate",""+rs.getString(20) );
        map.put("WarrantEndReason",""+rs.getString(21) );
        map.put("WarrantEndDate",""+rs.getString(22) );
        map.put("FinalDispositionDate",""+rs.getString(23) );
        map.put("FinalChargeLevel",""+rs.getString(24) );
        map.put("FinalChargeDegree",""+rs.getString(25) );
        map.put("OriginalChargeLevel",""+rs.getString(26) );
        map.put("OriginalChargeDegree",""+rs.getString(27) );
        map.put("FinalDispositionDetails",""+rs.getString(28) );
