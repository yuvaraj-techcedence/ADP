...
public final class VendorServiceIATPingClient extends SuperVendorServiceClient {
	...
	public static void main(String args[]) throws Exception {
		...
		VendorServiceIATPingClient client = new VendorServiceIATPingClient();
		client.setService(wsdlURL,"IAT");
		client.runTest();
	}

	private void runTest() {
		System.out.println("Invoking ping(IAT)...");

		MessageVendorPing _ping_pingRequest = new MessageVendorPing();
		_ping_pingRequest.setUserId(p.getProperty("iat_userid"));

		try {
			MessageVendorAcknowledgement _ping__return = portiAT
