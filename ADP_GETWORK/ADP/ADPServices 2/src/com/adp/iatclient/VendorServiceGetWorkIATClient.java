...
public final class VendorServiceGetWorkIATClient extends VendorServiceSuperGetWork {
	...
	public static void main(String args[]) throws Exception {
		...
		VendorServiceGetWorkIATClient client = new VendorServiceGetWorkIATClient();
