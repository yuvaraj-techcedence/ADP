...
public final class VendorService_VendorServiceFitImplPort_Client {
    ...
    private VendorService_VendorServiceFitImplPort_Client() {
    }
    ...
    public static void main(String args[]) throws Exception {
      ...
      VendorServiceFitImplService ss = new VendorServiceFitImplService(wsdlURL, SERVICE_NAME);
      VendorServiceFit port = ss.getVendorServiceFitImplPort();  
...
signatureProps.put(WSHandlerConstants.ACTION,
	WSHandlerConstants.USERNAME_TOKEN + " "
			...
			+ WSHandlerConstants.SIGNATURE);
signatureProps.put(WSHandlerConstants.USER, "vendorfit@vendorxml");
...
File truststore = new File("../Certs/fit/ditkeystore.jks");
...
File truststore2 = new File(
	"../Certs/fit/mutualssl/mutualsslkeystore.jks");
